...
public class MemberDao {
    // 1. Read(단건조회) 아이디(id)를 기준으로 사용자 정보를 가져오는 메서드
    ...
    // 2. Read(전체조회): 모든 사용자 정보를 조회하는 메서드
    ...
    public void updateMember(Member member) throws SQLException {
        ...
        // >> 메모리 낭비 + 속도 저하
        //String str = "Hello";
        //str += " JDBC"; // str에 " JDBC"를 추가하는 것이 아니라! 기존 문자열은 버려지고 새로운 String 객체가 생성!
